...
export const NodeConfigSidebar: React.FC<NodeConfigSidebarProps> = ({
    ...
    const renderNodeHeaderSection = () => (
        <div style={sidebarStyles.nodeHeader}>
            ...
            {nodeSpec.description && (
                <p style={sidebarStyles.nodeDescription}>
                    {nodeSpec.description}
                </p>
            )}
            ...
            {(selectedNode.id || execution_status) && (
                <div style={nodeStyles.header.badgeContainer}>
                    {selectedNode.id && (
                        ...
                        >
                            <span style={nodeStyles.header.badgeLabel}>ID</span>
                    ...
                    {execution_status && (
                        <div
                            style={getStatusBadgeStyles(execution_status)}
                            title={`Execution Status: ${execution_status}`}
                        >
                            <div style={nodeStyles.header.statusIndicator} />
    ...
    const renderParametersSection = () => {
        if (nodeSpec.parameters.length === 0) {
            return (
                <div style={sidebarStyles.emptyStateText}>No parameters</div>
            );
        }
    ...
    return (
        ...
        >
            ...
            <div style={sidebarStyles.content}>
                ...
                <SidebarSection title="Parameters" defaultCollapsed={false}>
