    ...
    return (
        <>
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Restore Flow Snapshot</DialogTitle>
                        <DialogDescription>
                            Are you sure you want to restore flow snapshot
                            version {String(snapshot.version).padStart(3, '0')}?
                            This will replace your current flow with this
                            snapshot.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Delete Flow Snapshot</DialogTitle>
                        <DialogDescription>
                            Are you sure you want to delete flow snapshot
                            version {String(snapshot.version).padStart(3, '0')}?
