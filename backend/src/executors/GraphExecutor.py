...
class GraphExecutor:
    ...
    def _prepare_start_node_from_ancestors(
        ...
        try:
            ...
            start_graph_node = self.graph.nodes.get(start_node)
            ...
            start_node_spec: NodeSpec = start_graph_node.get("spec")
            ...
            for ancestor_id in ancestors:
                ancestor_graph_node = self.graph.nodes.get(ancestor_id)
                ...
                ancestor_spec: NodeSpec = ancestor_graph_node.get("spec")
                ...
                edge_data = self.graph.get_edge_data(ancestor_id, start_node)
                if not edge_data:
                    logger.debug(
            ...
            self.graph.nodes[start_node]["data"] = start_node_data
            logger.info(
