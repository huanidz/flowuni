...
NOTE: Use this to replace the env.py file in the alembic folder
...
from src.models.alchemy import BaseModel
logger.info("Linked models: ", BaseModel.metadata.tables.keys())
